...
class RateCardViewSet(SnippetViewSet):
    ...
    list_display = ("id", "creator", "creator_name", "platform", "type", "duration", "price", "is_active")
    list_export = ("id", "creator.username", "creator_name", "platform", "type", "duration", "price", "min_price", "max_price", "is_active")
