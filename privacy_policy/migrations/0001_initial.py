...
def seed_initial_privacy_policies(apps, schema_editor):
    PrivacyPolicyGuide = apps.get_model("privacy_policy", "PrivacyPolicyGuide")
    ...
    for p in initial_policies:
        PrivacyPolicyGuide.objects.create(
            guide_id=p["guide_id"],
            title=p["title"],
            content=p["content"],
...
def reverse_seed(apps, schema_editor):
    PrivacyPolicyGuide = apps.get_model("privacy_policy", "PrivacyPolicyGuide")
    PrivacyPolicyGuide.objects.all().delete()
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        default="public",
                        help_text="Determine whether this privacy policy guide shows for public, businesses, creators, both, or support.",
                        max_length=50,
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Only active privacy policy guides will be shown in the dashboards and public site.",
                    ),
                ),
            ...
            options={
                "verbose_name": "Privacy Policy Guide",
                "verbose_name_plural": "Privacy Policy Guides",
            },
        ),
        migrations.RunPython(seed_initial_privacy_policies, reverse_seed),
    ]
